    ...
    return (
        <>
            <section className='container mb-[121px] flex flex-col items-center'>
                <h1 className='font-ptSerif font-normal text-[48px] text-commonColor'>Why <span className='text-brandColor'>choose</span> us</h1>
                <p className='w-[526px] font-inter font-medium text-lg text-[#A0A79A] leading-[145%] mt-[21px] text-center'>SLorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's</p>
                <ul className='flex gap-5 mt-[60px] rounded-md'>
