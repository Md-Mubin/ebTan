            ...
            <section className='w-full lg:py-[144px]'>
                <div className="container flex flex-col lg:flex-row mt-10 lg:mt-0 gap-16 lg:gap-10 xl:gap-[120px] items-center">
                    ...
                    <ul>
                        ...
                        <li className='mt-[37px] flex items-center gap-4 xl:gap-[27px]'>
                            <CommonButton /> 
                            <span className='font-ptSerif font-normal text-2xl xl:text-[31px] text-brandColor leading-[145%]'>৳ 500</span>
                        </li>
                    </ul>
                </div>
            </section>
